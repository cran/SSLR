...
In [`Model list section`](../../docs/articles/models.html) you can see the list of different classification and regression models.
...
* Call `fit` with formula, `fit_xy` with x and y, or `fit_x_u` with x and unlabeled data. See [`Model fitting section`](../../docs/articles/fit.html).
